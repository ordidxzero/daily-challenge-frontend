...
const LIGHT_GREEN_COLOR = '#2ecc71';
const LIGHT_RED_COLOR = '#e74c3c';
const DARK_PURPLE_COLOR = '#4834d4';
...
//! main
//? Calendar
export const selectedDayBackgroundColor = LIGHT_GREEN_COLOR;
...
export const infoBoxDefaultBackgroundColor = DARK_BLUE_COLOR;
...
//! setting
//? SettingItem
export const switchFalseTrackColor = DARK_GRAY_COLOR;
export const switchTrueTrackColor = LIGHT_GREEN_COLOR;
